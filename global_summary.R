...
gm_summarise_runs <- function(numberOfRuns){
  ...
  dirin <- tk_choose.dir(default="~/oaf/Google Drive/data/OAF Soil Lab Folder/Projects/", caption = "Choose prediction sub-directory")
  ...
  rsq <- data.frame("new" = c( rs , "mean_rsquared") )
